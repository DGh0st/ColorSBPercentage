#include "CSBPGradientColorListController.h"

@implementation CSBPGradientColorListController
...
- (NSArray *)specifiers {
	if (!_specifiers) {
		_specifiers = [[self loadSpecifiersFromPlistName:@"GradientColor" target:self] retain];
	}
	return _specifiers;
}
