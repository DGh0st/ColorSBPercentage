...
#define kColorPath @"/var/mobile/Library/Preferences/com.dgh0st.colorsbpercentage.color.plist"

@implementation PercentageColorPrefs
+(PercentageColorPrefs *)sharedInstance {
	static PercentageColorPrefs *sharedObject = nil;
...
-(id)init {
	...
	if (self != nil) {
		...
		self.solidGreaterThan20Color = @"#80BB80";
...
-(void)updatePreferences {
	...
	self.solidGreaterThan20Color = [preferences objectForKey:@"solidColorGreaterThan20"] ?: @"#80BB80";
